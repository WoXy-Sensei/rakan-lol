...
const capitalizeFirstLetter_1 = require("../funcs/capitalizeFirstLetter");
class DragonService {
    static findChampionById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getChampion("key", id);
        });
    }
    static findChampionByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const newName = (0, capitalizeFirstLetter_1.default)(name);
            return yield this.getChampion("name", newName);
        });
    }
    ...
    static getDragonPath(path) {
        return __awaiter(this, void 0, void 0, function* () {
            const version = yield DragonService.getLatestVersion();
...
DragonService.dragon = "http://ddragon.leagueoflegends.com/cdn";
DragonService.communitydragon = "https://raw.communitydragon.org/latest/game/assets";
exports.default = DragonService;
